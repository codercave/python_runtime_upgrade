...
This is a sample template for python_runtime_upgrade - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name python_runtime_upgrade \
...
```bash
sam logs -n HelloWorldFunction --stack-name python_runtime_upgrade --tail
```
...
```bash
aws cloudformation delete-stack --stack-name python_runtime_upgrade
```
